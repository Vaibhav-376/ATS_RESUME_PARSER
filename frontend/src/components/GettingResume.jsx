                ...
                <TableBody>
                  {data.map((item, index) => (
                    ...
                    >
                      ...
                      <TableCell className="px-4 py-2 text-gray-600">
                        {item.content?.personal_infos?.phones?.length
                          ? item.content.personal_infos.phones.join(", ")
                          : "N/A"}
                      </TableCell>
                      <TableCell className="px-4 py-2 text-gray-600">
                        {item.content?.personal_infos?.mails?.length
                          ? item.content.personal_infos.mails.join(", ")
                          : "N/A"}
                      </TableCell>
                    </TableRow>
                  ))}
